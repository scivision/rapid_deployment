% BondedHDF5Spec.tex is a LaTeX file that defines the structure
% of the output of the final bonder stage of the 
% MIDAS-M beacon receiver.
%
% $Id: BondedHDF5Spec.tex 141 2007-08-10 17:56:39Z hguturu $
